...
function connexion() {
    ...
    var mot_de_passe = document.getElementById('password').value.toLowerCase();
...
fetch('/inscription_postgre', {
    ...
    .then(data => {
        if (data.message === '"'+nom_utilisateur+'"' ) {
            ...
            ouvrirPopup(data.message, false);
    ...
    .catch(erreur => {
        ...
        ouvrirPopup(erreur.message, false);
